...
ptt::OnAccept::OnAccept(MessageHandler* msh) : _msh(msh) {}
void ptt::OnAccept:: exec(NL::Socket* socket, NL::SocketGroup* group, void* reference) 
{
...
ptt::OnRead::OnRead(MessageHandler* msh) : _msh(msh) {}
void ptt::OnRead::exec(NL::Socket* socket, NL::SocketGroup* group, void* reference) {
...
ptt::OnDisconnect::OnDisconnect(MessageHandler* msh) : _msh(msh) {}
void ptt::OnDisconnect::exec(NL::Socket* socket, NL::SocketGroup* group, void* reference) {
...
void ptt::OnClientDisconnect::exec(NL::Socket* socket, NL::SocketGroup* group, void* reference) {
